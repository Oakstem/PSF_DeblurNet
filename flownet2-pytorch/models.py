...
class FlowNet2(nn.Module):
    ...
    def __init__(self, args, batchNorm=False, div_flow = 20.):
        ...
        self.upsample1_1 = nn.Upsample(size=self.args.crop_size, mode='bilinear')
    ...
    def forward(self, inputs):
        ...
        rgb_mean = inputs.contiguous().view(inputs.size()[:2]+(-1,)).mean(dim=2).view(-1,3,1,1)
        ...
        flownetc_flow = self.upsample1_1(flownetc_flow2*self.div_flow)
        ...
        concat1 = torch.cat((x, flownetc_flow / self.div_flow), dim=1)
        
        # flownets1
        flownets1_flow2 = self.flownets_1(concat1)[0]
        flownets1_flow = self.upsample1_1(flownets1_flow2*self.div_flow)
        ...
        concat2 = torch.cat((x, flownets1_flow / self.div_flow), dim=1)

        # flownets2
        flownets2_flow2 = self.flownets_2(concat2)[0]
        flownets2_flow = self.upsample1_1(flownets2_flow2 * self.div_flow)
        # if self.args.cuda:
        #     norm_flownets2_flow = self.channelnorm(flownets2_flow)
        # else:
        #     norm_flownets2_flow = flownets2_flow
        ...
        flownetsd_flow = self.upsample1_1(flownetsd_flow2 / self.div_flow)
        # if self.args.cuda:
        #     norm_flownetsd_flow = self.channelnorm(flownetsd_flow)
        # else:
        #     norm_flownetsd_flow = flownetsd_flow
        ...
        concat3 = torch.cat((x, flownetsd_flow, flownets2_flow), dim=1)
