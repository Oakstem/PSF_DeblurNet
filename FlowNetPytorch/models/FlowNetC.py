...
class FlowNetC(nn.Module):
    ...
    def __init__(self,batchNorm=True):
        ...
        self.conv3_add  = conv(self.batchNorm, 256,  473, kernel_size=5, stride=1)
    ...
    def forward(self, x):
        ...
        # x2 = x[:,3:]
        #
        out_conv1a = self.conv1(x)
        out_conv2a = self.conv2(out_conv1a)
        out_conv3 = self.conv3(out_conv2a)
        out_conv4 = self.conv3_add(out_conv3)
        #
        ...
        out_conv3 = self.conv3_1(out_conv4)
