...
def train_net(net,
    ...
    train_loader = load_data(dir_data, batch_size, train=True, shuffle=True)
    val_loader = load_data(dir_data, batch_size, train=False, shuffle=False)
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            for batch in train_loader:
                ...
                assert image_batch.shape[1] == net.n_channels, \
                    ...
                    f'but loaded images have {image_batch.shape[1]} channels. Please check that ' \
